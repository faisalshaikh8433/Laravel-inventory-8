            ...
            <x-card-body>
                <div class="grid grid-cols-12 gap-2">
                    <div class="col-span-12 md:col-span-6">
                        ...
                        <x-input id="name" type="text" name="name" class="mt-1 w-full" value="{{ old('name') }}" />
                        <x-input-error for="name" />
                    </div>
                    <div class="col-span-12 md:col-span-6">
                        <x-label for="email" value="Email" />
                        <x-input id="email" type="text" name="email" class="mt-1 w-full" value="{{ old('email') }}" />
                    ...
                    <div class="col-span-12 md:col-span-6">
                        ...
                        <x-input id="state" type="text" name="state" class="mt-1 w-full" value="{{ old('state') }}" />
                        <x-input-error for="state" />
                    </div>
                    <div class="col-span-12 md:col-span-6">
                        <x-label for="city" value="City" />
                        <x-input id="city" type="text" name="city" class="mt-1 w-full" value="{{ old('city') }}" />
                    ...
                    <div class="col-span-12 md:col-span-6">
                        ...
                        <x-input id="gstno" type="text" name="gstno" class="mt-1 w-full" value="{{ old('gstno') }}" />
